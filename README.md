Пройти по всем файлам и убедится что импорты делаются (сделать копию файла и прям запустить)
И убедиться что все пакеты, которые используются установлены в poetry в корне проекта
...
Проверить что во всех ipynb файлах есть указание пути до assets если там загружаются config
